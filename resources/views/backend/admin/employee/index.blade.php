                        ...
                        <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.employees.show', $data->id) }}" class="btn btn-info waves-effect " title="View Employee" >
                                            <i class="material-icons">visibility</i>
                                        </a>

                                        <a href="{{ route('admin.employees.edit', $data->id) }}" class="btn btn-warning waves-effect edit" title="Edit Employee">
