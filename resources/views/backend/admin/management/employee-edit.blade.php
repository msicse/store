...
<div class="container-fluid">
    <div class="block-header">
        <a href="{{ route('admin.management.employees') }}" class="btn btn-primary waves-effect pull-right" style="margin-bottom:10px;" >
                ...
                <div class="body table-responsive">
                    ...
                    <table class="table table-bordered">
                        <thead>
                            ...
                            <tr>
                                <form action="{{ route('admin.management.employees.update', $employee->id) }}" method="post">
                                    @csrf
