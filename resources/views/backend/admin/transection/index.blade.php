...
@section('title','Admin | Transections')
...
<div class="container-fluid">
    <div class="block-header">
        <a href="{{ route('admin.transections.create') }}" class="btn btn-primary waves-effect pull-right" style="margin-bottom:10px;" >
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                <form action="{{ route('admin.transections.update', $data->id) }}" method="post" >
                                        @csrf
                                        @method('PUT')
                                    <td>{{ $key+1 }}</td>
                                    ...
                                    <td>{{ $data->quantity }}</td>
                                    <td>
                                        <a href="{{ route('admin.transections.show', $data->id) }}" class="btn btn-info waves-effect " >
                                            <i class="material-icons">visibility</i>
                                        </a>
                                        
                                        @empty($data->return_date)
                                        <button type="submit"  title="Update Return Date " class="btn btn-success waves-effect">
